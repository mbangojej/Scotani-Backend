...
const { cpUpload, uploadSingle, uploadContentImage, uploadSingleVideo } = require('../../../utils/upload')
...
router.route('/set-password').put(cpUpload, controller.setPassword)
...
router.route('/upload-video').post(uploadSingleVideo, controller.videoUpload);
...
router.route('/verifyEmail/:adminId').put(controller.verifyEmail)
